...
namespace Electron2D.Binding.Box2D.Dynamics.Contacts
{
    public class ContactSolver
    {
        ...
        public void Setup(ContactSolverDef def)
        {
            var step = def.Step;
...
// Postconditions
                            ...
                            System.Diagnostics.Debug.Assert(Math.Abs(vn1 - cp1.velocityBias) < k_errorTol);
                            System.Diagnostics.Debug.Assert(Math.Abs(vn2 - cp2.velocityBias) < k_errorTol);
#endif
                            break;
                        }
