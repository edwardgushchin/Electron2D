...
namespace Electron2D.Binding.Box2D.Dynamics.Joints
{
    ...
    public class MouseJoint : Joint
    {
        ...
        {
            System.Diagnostics.Debug.Assert(def.Target.IsValid());
            System.Diagnostics.Debug.Assert(def.MaxForce.IsValid() && def.MaxForce >= 0.0f);
            System.Diagnostics.Debug.Assert(def.FrequencyHz.IsValid() && def.FrequencyHz >= 0.0f);
            System.Diagnostics.Debug.Assert(def.DampingRatio.IsValid() && def.DampingRatio >= 0.0f);
