...
namespace Electron2D.Binding.Box2D.Dynamics.Joints
{
    ...
    public class GearJoint : Joint
    {
        ...
        public GearJoint(GearJointDef def) : base(def)
        {
            ...
            System.Diagnostics.Debug.Assert(_typeA == JointType.RevoluteJoint || _typeA == JointType.PrismaticJoint);
            System.Diagnostics.Debug.Assert(_typeB == JointType.RevoluteJoint || _typeB == JointType.PrismaticJoint);
        ...
        {
            System.Diagnostics.Debug.Assert(ratio.IsValid());
            _ratio = ratio;
        }
