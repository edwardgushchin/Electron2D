...
namespace Electron2D.Binding.Box2D.Dynamics
{
    ...
    public class ContactManager : IAddPairCallback, IDisposable
    {
        ...
        static ContactManager()
        {
            ...
            {
                System.Diagnostics.Debug.Assert(0 <= type1 && type1 < ShapeType.TypeCount);
                System.Diagnostics.Debug.Assert(0 <= type2 && type2 < ShapeType.TypeCount);
            ...
            int indexB)
        {
            ...
            var reg = _registers[(int)type1, (int)type2]
                   ?? throw new NullReferenceException($"{type1} can not contact to {type2}");
            if (reg.Primary)
            {
        ...
        private void DestroyContact(Contact contact)
        {
            ...
            System.Diagnostics.Debug.Assert(0 <= typeA && typeB < ShapeType.TypeCount);
            System.Diagnostics.Debug.Assert(0 <= typeA && typeB < ShapeType.TypeCount);
        ...
        public void AddPairCallback(object proxyUserDataA, object proxyUserDataB)
        {
            ...
            if (!bodyB.ShouldCollide(bodyA)                        // Does a joint override collision? Is at least one body dynamic?
            ...
            System.Diagnostics.Debug.Assert(c != default, "Get null contact!");
        ...
        {
            System.Diagnostics.Debug.Assert(ContactCount > 0);
        ...
        public void Collide()
        {
            ...
            while (node != default)
            {
                ...
                if ((c.Flags & Contact.ContactFlag.FilterFlag) != 0)
                {
