...
namespace Electron2D.Binding.Box2D.Collision
{
    public static partial class CollisionUtils
    {
        ...
        private static EPAxis ComputeEdgeSeparation(TempPolygon polygonB, Vector2 v1, Vector2 normal1)
        {
        ...
        private static EPAxis ComputePolygonSeparation(TempPolygon polygonB, Vector2 v1, Vector2 v2)
        {
            var axis = new EPAxis
            {
            ...
            Transform xfB)
        {
            ...
            // Clip to side 1
            int np = ClipSegmentToLine(clipPoints1, clipPoints, refFace.SideNormal1, refFace.SideOffset1, refFace.I1);
