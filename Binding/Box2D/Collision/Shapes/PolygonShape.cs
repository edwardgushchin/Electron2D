...
namespace Electron2D.Binding.Box2D.Collision.Shapes
{
    ...
    public class PolygonShape : Shape
    {
        ...
        public void Set(Vector2[] vertices, int count = -1)
        {
            ...
            System.Diagnostics.Debug.Assert(3 <= count && count <= MaxPolygonVertices);
            ...
            for (;;)
            {
                System.Diagnostics.Debug.Assert(m < MaxPolygonVertices);
                hull[m] = ih;
        ...
        public void SetAsBox(float hx, float hy, Vector2 center, float angle)
        {
            SetAsBox(hx, hy);
            Centroid = center;
            var transform = new Transform(center, angle);
