...
Публичный runtime API Electron2D `0.1-preview` воспроизводит утверждённый 2D-профиль Godot `4.7-stable` .NET/C# API под namespace `Electron2D`. Это техническая совместимость с выбранным API-подмножеством Godot, а не обещание реализовать весь Godot API.
