...
Задача не выбирает production physics backend, не раскрывает Box2D.NET или другие внутренние handles и не добавляет новый публичный API. Baseline строится поверх существующих Godot-like узлов и AABB-границ активных `CollisionShape2D`.
