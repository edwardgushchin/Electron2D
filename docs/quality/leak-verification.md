...
`0.1.0 Preview` должен иметь короткую автоматическую проверку утечек для подсистем, где уже есть счётчики жизненного цикла: реестр текстур и целей рендеринга, голоса звуковой подсистемы, идентификаторы физики (`RID`) и циклы загрузки/выгрузки сцен.
