# Бюджеты производительности и длительные критерии `0.1-preview`
...
`0.1-preview` должен иметь проверяемые ожидания производительности до появления полноценной среды выполнения. Эта матрица задаёт релизный контроль для будущих задач рендеринга, физики, ввода, аудио, редактора и экспорта.
