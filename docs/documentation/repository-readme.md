...
iOS показывается только как future runtime target и не входит в mandatory `0.1.0 Preview` gate. WebAssembly не должен появляться в README как planned/roadmap entry.
