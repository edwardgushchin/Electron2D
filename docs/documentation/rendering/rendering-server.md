...
Задачи: `T-0022`, `T-0023`, `T-0024`, `T-0025`, `T-0031`.
...
- Public `ShaderMaterial`, uniforms, samplers, real texture GPU transfer и real canvas item draw submission ещё не реализованы.
- Shader import baseline уже создаёт compiled artifacts, но не привязывает их к реальному draw pipeline.
