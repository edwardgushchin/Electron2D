...
- Use subagents only for scoped read-heavy work unless the user explicitly asks for parallel edits. The main agent owns final edits, verification, and commit composition.
