...
1. `T-0210` — переключить CI, AGENTS и документацию на C# tool после закрытой `T-0209`.
2. `T-0206` — закрыть tracking полной миграции repository automation после `T-0210`.
